...
public class PlayerController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (Player_1 == true){
            ...
            float moveHorizontalP1 = Input.GetAxis("MoveHorizontalP1");
            float moveVerticalP1 = Input.GetAxis("MoveVerticalP1");
            ...
            float moveHorizontalP2 = Input.GetAxis("MoveHorizontalP2");
            float moveVerticalP2 = Input.GetAxis("MoveVerticalP2");
